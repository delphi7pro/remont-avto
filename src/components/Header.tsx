      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-gray-800">АвтоСервис Pro</span>
          </Link>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/parts" className="text-gray-700 hover:text-blue-600 transition-colors">
              Запчасти
            </Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t">
            <nav className="flex flex-col space-y-4">
              ...
              <Link to="/diagnostics" className="text-gray-700 hover:text-blue-600">Диагностика</Link>
              <Link to="/parts" className="text-gray-700 hover:text-blue-600">Запчасти</Link>
